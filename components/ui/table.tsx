...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left align-middle md:text-xl font-medium text-[#0656FE] [&:has([role=checkbox])]:pr-0 dark:text-neutral-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("p-4 md:text-lg align-middle [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
))
